...
const schema = yup
  .object({
    ...
    numberGuests: yup.number().required("Please choose the number of guests"),
  })
  .required();
...
function EditBooking(props) {
  ...
  const onCancelHandler = async (e) => {
    const url =
      "https://api.noroff.dev/api/v1/holidaze/bookings/" + props.data.id;
    const token = localStorage.getItem("Token");
          ...
          <form className="d-flex flex-column justify-content-between flex-wrap ms-2">
            <div className="d-flex flex-column fs-5">
              ...
              <DateInput
                ...
                id="dateArrival"
                {...register("dateArrival").value}
                selected={arrivalDate}
                onChange={(date) => setArrivalDate(date)}
                type="date"
                minDate={date}
                excludeDates={getDaysArray(venue.bookings)}
            ...
            <div className="d-flex flex-column fs-5">
              ...
              <InputGuests className="d-flex">
                <input
                  ...
                  defaultValue={props.data.guests}
                ></input>
            ...
            <div className="d-flex flex-wrap gap-2">
              ...
              <ButtonSmaller onClick={handleSubmit(onEditHandler)}>
                Edit
              </ButtonSmaller>
            </div>
          </form>
