    ...
    <nav className="row h-100 w-100 align-items-center py-3">
      <div className="col-4 col-sm-4 col-md-3 col-xl-2 d-flex justify-content-end px-0 ms-1">
        <Link
          ...
          aria-label="takes you back to front page"
        >
          <Logo
            src={holidazeLogo}
            alt="The Holidaze brand logo. A house shape with a circle in the middle depicting the sun"
            className="mb-2"
          />
      ...
      <div className="col px-0">
        ...
        {token && manager === "false" ? (
          <ul className="row mb-0 list-style-type-none list-unstyled justify-content-end">
            ...
            <li className="col-3 col-sm-2 px-0 text-center">
              <NavLinkDiv onClick={() => handleLogout()}>Log out</NavLinkDiv>
            </li>
          </ul>
        ) : (
          ""
        ...
        {token && manager === "true" ? (
          <ul className="row mb-0 list-style-type-none list-unstyled justify-content-end">
            <li className="col-4 col-sm-3 col-md-2 col-xxl-1 px-0 me-2 text-center">
              <NavLink to="New-Venue">New Venue</NavLink>
            </li>
            <li className="col-3 col-sm-3 col-md-2 col-xxl-1 px-0 text-center">
              <NavLink to={`/profile/${name}`}>Profile</NavLink>
            </li>
