        ...
        <div className="d-flex gap-3">
          <div>
            <div className="d-flex align-items-center">
              <Check
                onChange={(e) => setWifiInput(e.currentTarget.checked)}
                id="wifi"
                type="checkbox"
              ></Check>
            ...
            <div>
              <Check
                onChange={(e) => setParkingInput(e.currentTarget.checked)}
                id="parking"
                type="checkbox"
              ></Check>
              <label className="fs-5 ms-2" htmlFor="parking">
                Parking
              </label>
            </div>
          </div>
          <div>
            <div>
              <Check
                onChange={(e) => setBreakfastInput(e.currentTarget.checked)}
                id="breakfast"
                type="checkbox"
              ></Check>
              <label className="fs-5 ms-2" htmlFor="breakfast">
                Breakfast
              </label>
            </div>
            <div>
              <Check
                onChange={(e) => setPetsInput(e.currentTarget.checked)}
                id="pets"
                type="checkbox"
              ></Check>
