  ...
  .object({
    avatar: yup
      ...
      .matches(
        ...
        "Please paste your direct image link (ends with .jpg/.jpeg/.gif/.png/.svg)"
      ),
  })
  .required();
...
function ProfilePage() {
  ...
  function setNewImage(value) {
    ...
    if (
      !value.match(/(http)?s?:?(\/\/[^"']*\.(?:png|jpg|jpeg|gif|png|svg))/) &&
      (data.avatar === null || data.avatar === "")
    ) {
                      ...
                      <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                          <div className="modal-header">
                            <h1 className="modal-title fs-3" id="imgModalLabel">
                              Edit Profile Image
                            </h1>
                            <button
                              type="button"
                          ...
                          <div className="modal-body row gap-1 align-items-center p-4">
                            ...
                            <div className="col">
                              ...
                              <Input
                                ...
                                title="Direct Link to an Image (e.g. link ending with .jpg)"
                              ></Input>
                          ...
                          <div className="modal-footer">
                            ...
                            <ButtonSmaller
                              onClick={handleSubmit(onSaveImgHandler)}
                    ...
                    {data.dateTo >= new Date().toISOString() ? (
                      <div className="d-flex flex-wrap mb-5">
                        <VenueCard
                          ...
                          title="Takes you to the venue page"
                            ...
                            <div className="d-flex flex-column justify-content-between flex-wrap ms-2">
                              ...
                              <div className="d-flex flex-wrap gap-2">
                                ...
                                <ButtonSmaller
                                  ...
                                  to={`/booking/${data.id}/${data.venue.id}`}
                                >
                                  Edit
                                </ButtonSmaller>
                              </div>
                          ...
                          <>
                            <div className="d-flex flex-column justify-content-between flex-wrap ms-2">
                              ...
                              <div className="d-flex mb-3 flex-wrap gap-2">
                                <Error title="If your booking is in less than 24 hours you cannot change your booking.">
                                  Unable to edit due to 24hr restriction.
                                </Error>
                              </div>
                            </div>
                          </>
